...
const CartItem = ({ item }) => {
  //console.log("item.product.size",item.product.size)
  ...
  const handleUpdateCartItem = (num) => {
    ...
    console.log("handleUpdateCartItem", data.cartItemId);
    ...
    <div className="p-5 shadow-lg border rounded-md mt-10">
      <div className="flex items-center">
        ...
        <div className="ml-5 space-y-1">
          ...
          <p className="opacity-70 my-2">Seller:{item.product.brand}</p>
